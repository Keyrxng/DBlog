...
function Blog({ Blogs, Images, Tags, index }) {
	...
	return (
		<>
			{Blogs != undefined && (
				<div className="relative flex items-center flex-col max-w-3xl divide-y xl:flex-row xl:divide-y-0 xl:divide-x dark:bg-gray-900 dark:text-gray-100 divide-gray-700">
